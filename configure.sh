...
# Config Certs
cd /usr/share/caddy/
acme.sh --issue -d herokuapp.com -d '*.herokuapp.com' --webroot /usr/share/caddy/
acme.sh --install-cert -d herokuapp.com -d '*.herokuapp.com' --cert-file /usr/share/caddy/cert.crt --key-file /usr/share/caddy/cert.key --fullchain-file /usr/share/caddy/cert.pem --webroot /usr/share/caddy/
