...
# Run XRay
tor & /usr/local/bin/xray -config /usr/local/etc/xray/config.json & /usr/bin/caddy list-modules & /usr/bin/caddy run --config /etc/caddy/Caddyfile --adapter caddyfile
